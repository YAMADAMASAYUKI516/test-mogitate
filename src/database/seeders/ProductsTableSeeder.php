...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $product = [
            'name' => 'キウイ',
            'price' => '800',
            'image' => 'storage/fruits-img/kiwi.png',
        ...
        $product = [
            'name' => 'ストロベリー',
            'price' => '1200',
            'image' => 'storage/fruits-img/strawberry.png',
        ...
        $product = [
            'name' => 'オレンジ',
            'price' => '850',
            'image' => 'storage/fruits-img/orange.png',
        ...
        $product = [
            'name' => 'スイカ',
            'price' => '700',
            'image' => 'storage/fruits-img/watermelon.png',
        ...
        $product = [
            'name' => 'ピーチ',
            'price' => '1000',
            'image' => 'storage/fruits-img/peach.png',
        ...
        $product = [
            'name' => 'シャインマスカット',
            'price' => '1400',
            'image' => 'storage/fruits-img/muscat.png',
        ...
        $product = [
            'name' => 'パイナップル',
            'price' => '800',
            'image' => 'storage/fruits-img/pineapple.png',
        ...
        $product = [
            'name' => 'ブドウ',
            'price' => '1100',
            'image' => 'storage/fruits-img/grapes.png',
        ...
        $product = [
            'name' => 'バナナ',
            'price' => '600',
            'image' => 'storage/fruits-img/banana.png',
        ...
        $product = [
            'name' => 'メロン',
            'price' => '900',
            'image' => 'storage/fruits-img/melon.png',
